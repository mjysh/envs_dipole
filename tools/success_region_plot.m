...
% plot_successRate(source,name, n_angle, ang_start, ang_end);
policy_name = 'geo_test7';
test_name = 'long_middle';
plot_successRate(source, policy_name, test_name, n_angle,ang_start,ang_end);
plot_timeUsed(source, policy_name, test_name, n_angle,ang_start,ang_end);
% name = 'egograd1';
% plot_successRate(source,name, n_angle, ang_start, ang_end);
% % 
...
%%
function plot_successRate(source, policy_name, test_name, n_angle,ang_start,ang_end)
load([source policy_name '/success_region_' test_name '/success_region.mat'])
targetX = target(1);
targetY = target(2);
...
the = 0:pi/200:pi*2;
plot(-12+2*cos(the),-2.15+2*sin(the),'k');
exportgraphics(gcf,['./savedFigs/' policy_name test_name '_successrate.eps'])
end
%%
function plot_timeUsed(source, policy_name, test_name, n_angle,ang_start,ang_end)
load([source policy_name '/success_region_' test_name '/success_region.mat'])
...
the = 0:pi/200:pi*2;
plot(-12+2*cos(the),-2.15+2*sin(the),'k');
exportgraphics(gcf,['./savedFigs/' policy_name test_name '_timeconsumption.eps'])
end
