...
obsMode = 'geoOneSensor'             # choice of observations, 'labframeOneSensor','egoOneSensor','egoOneSensorPlusOrt','egoTwoSensorLR','egoTwoSensorFB'
##===============================================================================================##
dt = 0.1
...
cfdpath = '/home/yusheng/cylinder_flow/Re=300/'
...
cfdDomainU = 6
cfdDomainD = -6
time_span = 4.63                 # maximum simulation time (one wake period)
